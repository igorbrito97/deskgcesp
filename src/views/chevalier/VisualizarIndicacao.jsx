            ...
            </Grid>
            {
              ...
              <Grid item>
                <Button
                  ...
                  color="primary"
                  type="button"
                  onClick={() => this.toggleModal("encerrarModal")}
                >
                  Encerrar votação
                </Button>
                <Modal
                  className="modal-dialog-centered"
                  isOpen={this.state.encerrarModal}
                  toggle={() => this.toggleModal("encerrarModal")}
                >
                  ...
                  <div className="modal-body">Deseja confirmar o encerramento da votação deste indicação?</div>
                  <div className="modal-footer">
                    ...
                    <Button color="primary" type="button"
                      onClick={() => {
                        encerrarVotacao(indicacao.indic_cod,this.getData());
                        this.toggleModal("encerrarModal");
                      }}
                    >
                      Confirmar
                </Button>
                              ...
                              >
                                <Grid item>
                                  <Button
                                    ...
                                    type="button"
                                    onClick={() => {
                                      this.toggleModal('encaminharModal')
                                    }}
                                  >
                                  ...
                                  <Modal
                                    className="modal-dialog-centered"
                                    isOpen={this.state.encaminharModal}
                                    toggle={() => this.toggleModal("encaminharModal")}
                                  >
                                    <div className="modal-header">
                                      <h5 className="modal-title" id="encaminharModalLabel">
                                        Atenção!!
                                  </h5>
                                      <button
                                        aria-label="Close"
                                        ...
                                        data-dismiss="modal"
                                        type="button"
                                        onClick={() => this.toggleModal("encaminharModal")}
                                      >
                                        <span aria-hidden={true}>×</span>
                                      </button>
                                    </div>
                                    <div className="modal-body">Deseja confirmar o encaminhamento dessa indicação?</div>
                                    <div className="modal-footer">
                                      <Button
                                        color="secondary"
                                        data-dismiss="modal"
                          ...
                          }
                          {
                            ...
                            >
                              ...
                              <Modal
                                ...
                                toggle={() => this.toggleModal("abrirModal")}
                              >
                                <div className="modal-header">
                                  <h5 className="modal-title" id="abrirModalLabel">
                                    Atenção!!
                              </h5>
                                  <button
                                    aria-label="Close"
                                    ...
                                    data-dismiss="modal"
                                    type="button"
                                    onClick={() => this.toggleModal("abrirModal")}
                                  >
                                    <span aria-hidden={true}>×</span>
                                  </button>
                                </div>
                                <div className="modal-body">Deseja confirmar a abertura da votação deste indicação?</div>
                                <div className="modal-footer">
                                  <Button
                                    color="secondary"
                                    data-dismiss="modal"
