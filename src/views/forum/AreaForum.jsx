...
import { getAllAreaForum, deleteAreaForum, addAreaForum, updateAreaForum } from "services/forumService";
                            ...
                            <Button color="primary" type="button"
                              onClick={() => {
                                if (this.state.nome === "")
                                  ...
                                  addAreaForum(this.state.nome,this.state.descricao);
                            ...
                            >
                              <td className="text-right">
                                <UncontrolledDropdown onClick={() => {
                                  ...
                                  this.setState({
                                    id: areas[item].areaforum_cod,
                                    nome: areas[item].areaforum_nome,
                                    descricao:areas[item].areaforum_descricao
                                  })
                                }}>
                                  <DropdownToggle
                                        ...
                                        <Button color="primary" type="button"
                                          onClick={() => {
                                            if (this.state.nome === "")
                                              ...
                                              updateAreaForum(this.state.id,this.state.nome,this.state.descricao);
