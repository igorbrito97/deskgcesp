...
import { getAllAreaTickets, deleteAreaTicket, addAreaTicket, updateAreaTicket } from "services/ticketsService";
                            ...
                            <Button color="primary" type="button"
                              onClick={() => {
                                if (this.state.nome === "")
                                  ...
                                  addAreaTicket(this.state.nome, this.state.descricao);
                            ...
                            >
                              <td className="text-right">
                                <UncontrolledDropdown onClick={() => {
                                  ...
                                  this.setState({
                                    id: areas[item].areaticket_cod,
                                    nome: areas[item].areaticket_nome,
                                    descricao: areas[item].areaticket_descricao
                                  })
                                }}>
                                  <DropdownToggle
                                  ...
                                  <DropdownMenu className="dropdown-menu-arrow" >
                                    <DropdownItem href="#pablo" onClick={() => this.toggleModal('updateModal')}>
                                      Alterar
                                </DropdownItem>
                                    <Modal
                                      id="updateModal"
                                        ...
                                        <Button color="primary" type="button"
                                          onClick={() => {
                                            if (this.state.nome === "")
                                              ...
                                              updateAreaTicket(this.state.id, this.state.nome, this.state.descricao);
